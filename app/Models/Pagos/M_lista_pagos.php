	...
	class M_lista_pagos extends Model{
		...
		public function lista_pagos(){
			$respuesta=$this->db->query("
				select row_number()over() as nro, ae.id_estudiante, cdp.id_det_pago, tutor.tutor, tutor.celular, concat(rp.nom_persona,' ',rp.ap_pat_persona,' ',rp.ap_mat_persona)as estudiante, cdp.monto_cancelado, cdp.monto_deuda, cdp.estado, cdp.fec_pago::date
				from com_pago cp, com_detalle_pago cdp, aca_inscripcion ai, aca_estudiante ae, ral_persona rp, 
