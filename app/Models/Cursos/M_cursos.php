	...
	class M_cursos extends Model{
		...
		public function listar_cursos(){
			$respuesta=$this->db->query("
				select row_number()over() as nro, id_categoria,detalle 
				from ral_categoria 
		...
		public function registrar_curso($curso){
			$respuesta=$this->db->query("
				insert 
				into ral_categoria (cod_categoria,tipo,nombre_categoria,detalle,estado) 
				values ('CUR-CRE-04','curso','materia-curso','$curso','activo');
			");
			return $respuesta;
		}
