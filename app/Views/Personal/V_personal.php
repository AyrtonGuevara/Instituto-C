	...
	<form action="<?php echo base_url()?>personal/agregar_personal" method="POST" name="form_personal" id="form_personal" class="form_control" accept-charset="utf-8">
		<div class="row">
			...
			<div>
				...
				<input type="submit" class="btn btn_primary" name="Modificar" value="Modificar" id="Modificar" disabled>
			</div>
		</div>
	</form>
	<div class="container">
		<table class="responsive table">
			...
			<tbody>
					...
					foreach ($list->getResult() as $key) {
						...
						echo "<td><input type='button' class='btn btn-info' name='Modificar' value='Modificar' onclick='modificar_personal(".$key->id_personal.")'><input type='button' class='btn btn-danger' name='Eliminar' value='Eliminar' onclick=eliminar_personal(".$key->id_personal.")></td></tr>";
					}
					?>
			</tbody>
		</table>
