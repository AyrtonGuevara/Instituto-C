			...
			<div class="position_relative">
				<div class="row position-absolute top-50 start-50 translate-middle">
					<div class="">
						...
						<input type="text" class="form-control" name="usuario" value="" placeholder="Ingrese el Usuario">
						<label for="psswd" class="form-label">Contraseña:</label>
						<input type="password" class="form-control" name="psswrd" value="" placeholder="Ingrese Contraseña">
					</div>
					<div>
