...
<div id="sidenav" class="sidenav">
	...
	<ul style="color:white;" id="accordion">
		<?php
		if(array_search('1-0',$menu_permisos)){
		?>
		...
		<ul id="col1" class="collapse" data-bs-parent="#accordion">
			...
			if(array_search('1-3',$menu_permisos)){
			?>
		...
		<?php }
		if(array_search('2-0',$menu_permisos)){
		?>
		...
		<ul id="col2" class="collapse" data-bs-parent="#accordion">
			<?php
			if(array_search('2-1',$menu_permisos)){
			?>
			...
			if(array_search('2-2',$menu_permisos)){
			?>
		...
		<?php }
		if(array_search('3-0',$menu_permisos)){
		?>
		...
		<ul id="col3" class="collapse" data-bs-parent="#accordion">
			<?php
			if(array_search('3-1',$menu_permisos)){
			?>
			...
			if(array_search('3-2',$menu_permisos)){
			?>
			...
			if(array_search('3-3',$menu_permisos)){
			?>
			...
			if(array_search('3-4',$menu_permisos)){
			?>
			...
			if(array_search('3-5',$menu_permisos)){
			?>
			...
			if(array_search('3-6',$menu_permisos)){
			?>
			...
			if(array_search('3-7',$menu_permisos)){
			?>
		...
		<?php }
		if(array_search('4-0',$menu_permisos)){
		?>
		...
		<ul id="col4" class="collapse" data-bs-parent="#accordion">
			<?php
			if(array_search('4-1',$menu_permisos)){
			?>
		...
		<?php }
			if(array_search('5-0',$menu_permisos)){
		?>
		...
		<ul id="col5" class="collapse" data-bs-parent="#accordion">
			<?php
			if(array_search('5-1',$menu_permisos)){
			?>
			...
			if(array_search('5-2',$menu_permisos)){
			?>
		...
		<?php }
			if(array_search('6-0',$menu_permisos)){
			?>
		...
		<ul id="col6" class="collapse" data-bs-parent="#accordion">
			<?php
			if(array_search('6-1',$menu_permisos)){
			?>
