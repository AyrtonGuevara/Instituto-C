...
*/
	$this->extend('Template/Head',$title);
...
//para los tipos de pago
	...
	//calcular la edad de los extudiantes
	...
	//select horarios dependiendo de la materia
	...
	//calculo del tiempo de la inscripcion y el precio del curso
